                                        ...
                                        <div class="card-title mb-4">
                                            <div class="d-flex justify-content-start">
                                                ...
                                                <div class="image-container">
                                                    <img src="<?= user::getAvatar($objet->email) ?>" id="imgProfile"
                                                ...
                                                <div class="userData ml-3">
                                                    <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold">
                                                        ...
                                                        <span
                                                            class="en"><i><?= $objet->typeUser == 'Medecin' ? '(' . $objet->specialite . ')' : '(Simple User)' ?></i></span>
                                                    </h2>
                                                    <h6 class="d-block">&nbsp;
                                                        <a href="https://wa.me/<?= substr($objet->telephone, 4, 10) ?>"><i
                                                                class="fab fa-whatsapp fa-2x"></i></a>&nbsp;
                                                        <a href="mailto:<?= $objet->email ?>"><i
                                                                class="fas fa-at fa-2x"></i></a>
                                                    </h6>
                                                    <h6 class="d-block ">
                                                        <?= Friend::getNumberFriend($objet->id) == 0 ? 'Aucune Relation &nbsp; <a class="btn btn-outline-primary btn-sm">Faire Des Relation</a>' : Friend::getNumberFriend($objet->id) . ' Contact  <a class="btn btn-outline-primary btn-sm">Visualiser</a> ' ?>
                                                    </h6>
                                                    ...
                                                    <h6>
                                                        ...
                                                        ?>
                                                        <a href=""
                                                            class="btn btn-outline-info mt-2"><i
                                                                class="fas fa-plus"></i>
                                                            Annuler Demande</a>
                                                        <?php
                                                            }else{
                                                        ?>
                                                        <a href="../App/Controller/sendRequest.ctrl.php?myId=<?= $_SESSION['session']['id'] ?>&id_user=<?= $objet->id ?>"
                                                            class="btn btn-outline-info mt-2"><i
                                                                class="fas fa-plus"></i>
                                                            Suivre</a>
                                                        <?php
                                                    ...
                                                    <div class="tab-pane fade" id="connectedServices" role="tabpanel"
                                                        ...
                                                        <div class="col-md-12 pt-4">
                                                            <div class="why-edit-box">
                                                                ...
                                                                <img src="https://www.researchedit.org/public/images/book-icon.png"
                                                                    alt="Book Icon">
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <form id="formu" accept-charset="UTF-8"
                                                    action="../App/Controller/PostStatus.ctrl.php" method="POST">
                                                    <textarea class="form-control counted" id="text"
                                                        <?= $objet->id !== $_SESSION['session']['id'] ? 'disabled' : '' ?>
                                                        <?= $objet->id !== $_SESSION['session']['id'] ? 'title="vous ne pouvez pas poster de status"' : 'title="Poster votre status"' ?>
                                                        name="text" placeholder="Type in your message" rows="5"
